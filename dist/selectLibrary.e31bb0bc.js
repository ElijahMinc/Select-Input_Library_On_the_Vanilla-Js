...
var getTemplate = function getTemplate() {
  ...
  var items = data.map(function (item) {
    if (item.id === selectedId) {
      item.value, _readOnlyError("text");
    }
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    key: "isOpen",
    get: function get() {
      // get -ер читается, как переменная ( не как вызов функции)
    ...
    value: function select(id) {
      ...
      this.element.querySelectorAll('[data-type="item"]').forEach(function (el) {
        return el.classList.remove('selected');
      });
      this.element.querySelector("[data-id=\"".concat(id, "\"]")).classList.add('selected');
...
function _render2() {
  // приватный элемент доступен ТОЛЬКО внутри этого класса, но недопуступен извне его.
...
//# sourceMappingURL=/selectLibrary.e31bb0bc.js.map